    ...
    return (
        <div>
            <div className="w-[95%] md:w-[85%] mx-auto px-[15px] py-[70px]">
                ...
                <h2 className="font-bold text-[25px] sm:text-[30px] mb-[30px] flex items-center gap-2">プライバシーポリシー</h2>

                <div className="mb-[50px]">
                    <h3 className="text-[20px] font-bold mb-[5px] text-[#aaa]">個人情報の取り扱いについて</h3>
                ...
                <div className="mb-[50px]">
                    <h3 className="text-[20px] font-bold mb-[5px] text-[#aaa]">外部コンテンツについて</h3>
